...
namespace Game.DataStorage
{
    public class CliDB
    {
        public static BitSet LoadStores(string dataPath, Locale defaultLocale)
        {
            ...
            TalentTabStorage                        = ReadDB2<TalentTabRecord>("TalentTab.db2", HotfixStatements.SEL_TALENT, HotfixStatements.SEL_TALENT_LOCALE);
            ...
            foreach (var node in TaxiNodesStorage.Values)
            {
                ...
                if (!Global.DB2Mgr.GetUiMapPosition(node.Pos.X, node.Pos.Y, node.Pos.Z, (int)node.ContinentID, 0, 0, 0, UiMapSystem.Adventure, false, out int uiMapId))
                    Global.DB2Mgr.GetUiMapPosition(node.Pos.X, node.Pos.Y, node.Pos.Z, (int)node.ContinentID, 0, 0, 0, UiMapSystem.Taxi, false, out uiMapId);
            ...
            if (!AreaTableStorage.ContainsKey(4140) ||                // last area added in 2.5.2.39618
                !CharTitlesStorage.ContainsKey(697) ||                // last char title added in 2.5.2.39618
                !GemPropertiesStorage.ContainsKey(1127) ||            // last gem property added in 2.5.2.39618
                !ItemStorage.ContainsKey(187815) ||                   // last item added in 2.5.2.39618
                !ItemExtendedCostStorage.ContainsKey(7085) ||         // last item extended cost added in 2.5.2.39618
                !MapStorage.ContainsKey(598) ||                       // last map added in 2.5.2.39618
                !SpellNameStorage.ContainsKey(359967))                // last spell added in 2.5.2.39618
            {
        ...
        public static DB6Storage<BroadcastTextRecord> BroadcastTextStorage = new();
        ...
        public static DB6Storage<PhaseRecord> PhaseStorage = new();
        public static DB6Storage<PhaseXPhaseGroupRecord> PhaseXPhaseGroupStorage = new();
        ...
        public static DB6Storage<ScalingStatDistributionRecord> ScalingStatDistributionStorage = new();
