...
namespace Game
{
    ...
    //        auctionHouse.BuildListBuckets(listBucketsResult, _player, browseQuery.Name, browseQuery.MinLevel, browseQuery.MaxLevel, browseQuery.Filters, classFilters, (byte)browseQuery.MaxPetLevel, browseQuery.Offset, browseQuery.Sorts, browseQuery.Sorts.Count);
    ...
    //                item.GetTemplate().GetFlags().HasAnyFlag(ItemFlags.Conjured) || item.GetUpdateField<uint>(ItemFields.Expiration) != 0 ||
