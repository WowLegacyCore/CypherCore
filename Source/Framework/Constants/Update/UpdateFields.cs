...
namespace Framework.Constants
{
    ...
    public enum PlayerFields
    {
        ...
        AvgItemLevel                                                      = UnitFields.End + 0x01D0,      // Size: 6, Flags: (All)
        CurrentBattlePetBreedQuality                                      = UnitFields.End + 0x01D6,      // Size: 1, Flags: (All)
        HonorLevel                                                        = UnitFields.End + 0x01D7,      // Size: 1, Flags: (All)
        CustomizationChoices                                              = UnitFields.End + 0x01D8,      // Size: 72, Flags: (All)
        End                                                               = UnitFields.End + 0x0220,
    }
    ...
    public enum ActivePlayerFields
    {
        ...
        ExploredZones                                                     = PlayerFields.End + 0x05C2,      // Size: 480, Flags: (All)
        RestInfo                                                          = PlayerFields.End + 0x07A2,      // Size: 4, Flags: (All)
        ModDamageDonePos                                                  = PlayerFields.End + 0x07A6,      // Size: 7, Flags: (All)
        ModDamageDoneNeg                                                  = PlayerFields.End + 0x07AD,      // Size: 7, Flags: (All)
        ModDamageDonePercent                                              = PlayerFields.End + 0x07B4,      // Size: 7, Flags: (All)
        ModHealingDonePos                                                 = PlayerFields.End + 0x07BB,      // Size: 1, Flags: (All)
        ModHealingPercent                                                 = PlayerFields.End + 0x07BC,      // Size: 1, Flags: (All)
        ModHealingDonePercent                                             = PlayerFields.End + 0x07BD,      // Size: 1, Flags: (All)
        ModPeriodicHealingDonePercent                                     = PlayerFields.End + 0x07BE,      // Size: 1, Flags: (All)
        WeaponDmgMultipliers                                              = PlayerFields.End + 0x07BF,      // Size: 3, Flags: (All)
        WeaponAtkSpeedMultipliers                                         = PlayerFields.End + 0x07C2,      // Size: 3, Flags: (All)
        ModSpellPowerPercent                                              = PlayerFields.End + 0x07C5,      // Size: 1, Flags: (All)
        ModResiliencePercent                                              = PlayerFields.End + 0x07C6,      // Size: 1, Flags: (All)
        OverrideSpellPowerByAPPercent                                     = PlayerFields.End + 0x07C7,      // Size: 1, Flags: (All)
        OverrideAPBySpellPowerPercent                                     = PlayerFields.End + 0x07C8,      // Size: 1, Flags: (All)
        ModTargetResistance                                               = PlayerFields.End + 0x07C9,      // Size: 1, Flags: (All)
        ModTargetPhysicalResistance                                       = PlayerFields.End + 0x07CA,      // Size: 1, Flags: (All)
        LocalFlags                                                        = PlayerFields.End + 0x07CB,      // Size: 1, Flags: (All)
        Bytes1                                                            = PlayerFields.End + 0x07CC,      // Size: 1, Flags: (All) Nested: (GrantableLevels, MultiActionBars, LifetimeMaxRank, NumRespecs)
        AmmoID                                                            = PlayerFields.End + 0x07CD,      // Size: 1, Flags: (All)
        PvpMedals                                                         = PlayerFields.End + 0x07CE,      // Size: 1, Flags: (All)
        BuybackPrice                                                      = PlayerFields.End + 0x07CF,      // Size: 12, Flags: (All)
        BuybackTimestamp                                                  = PlayerFields.End + 0x07DB,      // Size: 12, Flags: (All)
        Bytes2                                                            = PlayerFields.End + 0x07E7,      // Size: 1, Flags: (All) Nested: (TodayHonorableKills, YesterdayHonorableKills)
        Bytes3                                                            = PlayerFields.End + 0x07E8,      // Size: 1, Flags: (All) Nested: (LastWeekHonorableKills, ThisWeekHonorableKills)
        ThisWeekContribution                                              = PlayerFields.End + 0x07E9,      // Size: 1, Flags: (All)
        LifetimeHonorableKills                                            = PlayerFields.End + 0x07EA,      // Size: 1, Flags: (All)
        YesterdayContribution                                             = PlayerFields.End + 0x07EB,      // Size: 1, Flags: (All)
        LastWeekContribution                                              = PlayerFields.End + 0x07EC,      // Size: 1, Flags: (All)
        LastWeekRank                                                      = PlayerFields.End + 0x07ED,      // Size: 1, Flags: (All)
        WatchedFactionIndex                                               = PlayerFields.End + 0x07EE,      // Size: 1, Flags: (All)
        CombatRatings                                                     = PlayerFields.End + 0x07EF,      // Size: 32, Flags: (All)
        PvpInfo                                                           = PlayerFields.End + 0x080F,      // Size: 72, Flags: (All)
        MaxLevel                                                          = PlayerFields.End + 0x0857,      // Size: 1, Flags: (All)
        ScalingPlayerLevelDelta                                           = PlayerFields.End + 0x0858,      // Size: 1, Flags: (All)
        MaxCreatureScalingLevel                                           = PlayerFields.End + 0x0859,      // Size: 1, Flags: (All)
        NoReagentCostMask                                                 = PlayerFields.End + 0x085A,      // Size: 4, Flags: (All)
        PetSpellPower                                                     = PlayerFields.End + 0x085E,      // Size: 1, Flags: (All)
        ProfessionSkillLine                                               = PlayerFields.End + 0x085F,      // Size: 2, Flags: (All)
        UiHitModifier                                                     = PlayerFields.End + 0x0861,      // Size: 1, Flags: (All)
        UiSpellHitModifier                                                = PlayerFields.End + 0x0862,      // Size: 1, Flags: (All)
        HomeRealmTimeOffset                                               = PlayerFields.End + 0x0863,      // Size: 1, Flags: (All)
        ModPetHaste                                                       = PlayerFields.End + 0x0864,      // Size: 1, Flags: (All)
        Bytes4                                                            = PlayerFields.End + 0x0865,      // Size: 1, Flags: (All) Nested: (LocalRegenFlags, AuraVision, NumBackpackSlots)
        OverrideSpellsID                                                  = PlayerFields.End + 0x0866,      // Size: 1, Flags: (All, UrgentSelfOnly)
        LfgBonusFactionID                                                 = PlayerFields.End + 0x0867,      // Size: 1, Flags: (All)
        LootSpecID                                                        = PlayerFields.End + 0x0868,      // Size: 1, Flags: (All)
        OverrideZonePVPType                                               = PlayerFields.End + 0x0869,      // Size: 1, Flags: (All, UrgentSelfOnly)
        BagSlotFlags                                                      = PlayerFields.End + 0x086A,      // Size: 4, Flags: (All)
        BankBagSlotFlags                                                  = PlayerFields.End + 0x086E,      // Size: 7, Flags: (All)
        QuestCompleted                                                    = PlayerFields.End + 0x0875,      // Size: 1750, Flags: (All)
        Honor                                                             = PlayerFields.End + 0x0F4B,      // Size: 1, Flags: (All)
        HonorNextLevel                                                    = PlayerFields.End + 0x0F4C,      // Size: 1, Flags: (All)
        PvpTierMaxFromWins                                                = PlayerFields.End + 0x0F4D,      // Size: 1, Flags: (All)
        PvpLastWeeksTierMaxFromWins                                       = PlayerFields.End + 0x0F4E,      // Size: 1, Flags: (All)
        Bytes5                                                            = PlayerFields.End + 0x0F4F,      // Size: 1, Flags: (All) Nested: (InsertItemsLeftToRight, PvpRankProgress)
        End                                                               = PlayerFields.End + 0x0F50,
    }
