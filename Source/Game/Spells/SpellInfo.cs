    ...
    public class SpellInfo
    {
        ...
        public SpellCastResult CheckVehicle(Unit caster)
        {
            ...
            if (vehicle)
            {
                ...
                if (vehicleSeat.Flags.HasFlag(VehicleSeatFlags.CanControl | VehicleSeatFlags.Unk2))
                {
                    foreach (SpellEffectInfo effect in _effects)
                    {
        ...
        {
            float haste = caster.GetUpdateField<float>(UnitFields.ModHaste);
            float rangedHaste = caster.GetUpdateField<float>(UnitFields.ModRangedHaste);
            float spellHaste = caster.GetUpdateField<float>(UnitFields.ModSpellHaste);
            float regenHaste = caster.GetUpdateField<float>(UnitFields.ModHasteRegen);
        ...
        float CalcPPMCritMod(SpellProcsPerMinuteModRecord mod, Unit caster)
        {
            ...
            float crit = player.GetUpdateField<float>(ActivePlayerFields.CritPercentage);
            float rangedCrit = player.GetUpdateField<float>(ActivePlayerFields.RangedCritPercentage);
            float spellCrit = player.GetUpdateField<float>(ActivePlayerFields.SpellCritPercentage);
