        ...
        void ProcessAction(SmartScriptHolder e, Unit unit = null, uint var0 = 0, uint var1 = 0, bool bvar = false, SpellInfo spell = null, GameObject gob = null, string varString = "")
        {
            ...
            switch (e.GetActionType())
            {
                        ...
                        if (IsUnit(target))
                        {
                            switch (e.Action.setunitByte.type)
                            {
                                ...
                                case 3:
                                    ...
                                    target.ToUnit().SetAnimTier((UnitBytes1Flags)(target.ToUnit().GetUpdateField<byte>(UnitFields.Bytes2, 3) | e.Action.setunitByte.byte1), false);
                                    break;
                            }
                        }
                    }
                ...
                case SmartActions.SetGoFlag:
                {
                    foreach (var target in targets)
                        if (IsGameObject(target))
                            target.ToGameObject().SetGameObjectFlag((GameObjectFlags)e.Action.goFlag.flag);
                    break;
                }
                case SmartActions.AddGoFlag:
                {
                    foreach (var target in targets)
                        if (IsGameObject(target))
                            target.ToGameObject().AddGameObjectFlag((GameObjectFlags)e.Action.goFlag.flag);
                    break;
                }
                case SmartActions.RemoveGoFlag:
                {
                    foreach (var target in targets)
                        if (IsGameObject(target))
                            target.ToGameObject().RemoveGameObjectFlag((GameObjectFlags)e.Action.goFlag.flag);
                    break;
                }
            ...
            switch (e.GetTargetType())
            {
                ...
                case SmartTargets.HostileSecondAggro:
                    if (_me != null)
                    {
                        ...
                        {
                            Unit u = _me.GetAI().SelectTarget(SelectAggroTarget.MaxThreat, 1, new PowerUsersSelector(_me, (PowerType)(e.Target.hostilRandom.powerType - 1), e.Target.hostilRandom.maxDist, e.Target.hostilRandom.playerOnly != 0));
                            if (u != null)
                                targets.Add(u);
                        }
                        else
                        {
                            Unit u = _me.GetAI().SelectTarget(SelectAggroTarget.MaxThreat, 1, e.Target.hostilRandom.maxDist, e.Target.hostilRandom.playerOnly != 0);
                            if (u != null)
                                targets.Add(u);
                        }
                    }
                ...
                case SmartTargets.HostileLastAggro:
                    if (_me != null)
                    {
                        if (e.Target.hostilRandom.powerType != 0)
                        {
                            Unit u = _me.GetAI().SelectTarget(SelectAggroTarget.MinThreat, 1, new PowerUsersSelector(_me, (PowerType)(e.Target.hostilRandom.powerType - 1), e.Target.hostilRandom.maxDist, e.Target.hostilRandom.playerOnly != 0));
                            if (u != null)
                                targets.Add(u);
                        }
                        else
                        {
                            Unit u = _me.GetAI().SelectTarget(SelectAggroTarget.MinThreat, 1, e.Target.hostilRandom.maxDist, e.Target.hostilRandom.playerOnly != 0);
                            if (u != null)
                                targets.Add(u);
                        }
                    }
                ...
                case SmartTargets.HostileRandom:
                    if (_me != null)
                    {
                        if (e.Target.hostilRandom.powerType != 0)
                        {
                            Unit u = _me.GetAI().SelectTarget(SelectAggroTarget.Random, 1, new PowerUsersSelector(_me, (PowerType)(e.Target.hostilRandom.powerType - 1), e.Target.hostilRandom.maxDist, e.Target.hostilRandom.playerOnly != 0));
                            if (u != null)
                                targets.Add(u);
                        }
                        else
                        {
                            Unit u = _me.GetAI().SelectTarget(SelectAggroTarget.Random, 1, e.Target.hostilRandom.maxDist, e.Target.hostilRandom.playerOnly != 0);
                            if (u != null)
                                targets.Add(u);
                        }
                    }
                ...
                case SmartTargets.Farthest:
                    if (_me)
                    {
                        Unit u = _me.GetAI().SelectTarget(SelectAggroTarget.MaxDistance, 0, new FarthestTargetSelector(_me, e.Target.farthest.maxDist, e.Target.farthest.playerOnly != 0, e.Target.farthest.isInLos != 0));
                        if (u != null)
                            targets.Add(u);
                    }
                    break;
