...
namespace Game.Networking.Packets
{
    ...
    //    public ObjectGuid Guid = ObjectGuid.Empty;          //< the GUID of the bidder for this auction.
    //    public ulong MinIncrement = 0ul;                    //< the sum of outbid is (1% of current bid) * 5, if the bid is too small, then this value is 1 copper.
    //    public ulong Money = 0ul;                           //< the amount of money that the player bid in copper
